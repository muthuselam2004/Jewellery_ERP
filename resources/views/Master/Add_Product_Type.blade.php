...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <form method="POST" action="{{ route('Add_Pro_Type.Add_Pro_Type') }}">
            @csrf
            ...
            <div class="custom-report-card mb-3">
                ...
                <div class="report-body">
                    ...
                    <input type="hidden" id="Page_Name" value="Add_Product_Page">
                    ...
                    <div class="row align-items-end">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="text" name="Pro_Code" class="form-control custom-input" value="{{ $nextCode }}"
                                readonly>
                        </div>
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <select name="Category_Type" class="form-control select2 custom-input">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <select name="Manufacturing_Type" class="form-control select2 custom-input">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" name="Pro_Type" class="form-control custom-input"
         ...
         <div class="custom-table-card" id="table_card" style="display:none;">
            ...
            <table class="table custom-table" id="data_table">
                ...
                <tbody>
                    ...
                    @foreach($Pro_Type as $key => $pro)

                        <tr>
                            <td>{{ $key + 1 }}</td>
                            <td>{{ $pro->Item_Code }}</td>
                            <td>{{ $pro->Category_Name }}</td>
                            <td>{{ $pro->Category_Type }}</td>
                            <td>{{ $pro->Manufacturing_Type }}</td>
    ...
    @push('scripts')
        ...
        <script>
            var Page_Name = "Add_Product_Page";
        </script>
